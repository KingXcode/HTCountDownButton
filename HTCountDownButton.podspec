...
Pod::Spec.new do |s|
  ...
  s.version      = "1.0"
  s.summary      = "这是一个简单的倒计时按钮,分两种形式,一种是继承的button,一种是label的分类,实现方式相同."
  ...
  s.description  = <<-DESC
                      HTCountDownButton 是一个倒计时的按钮和label分类
                   DESC
  ...
  s.author             = { "niesiyang" => "kingxcode@icloud.com" }
  # Or just: s.author    = "niesiyang"
  # s.authors            = { "niesiyang" => "kingxcode@icloud.com" }
  ...
  s.source_files  = "CountDownButton/CountDownButton/HTCountDownButton/*.{h,m}"
